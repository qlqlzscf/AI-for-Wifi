...
for ind =1:numpk
    ...
    % Initialize the scrambler for each generated packet (NumPackets)
    % Using numMSDUs here can create an oversized vector and cause memory issues.
    scramblerInitialization = randi([1 127],numTxPkt,1);
    txWaveformforpk{ind} = wlanWaveformGenerator(txPSDUPerUser{ind},cfgSU, ...
      ...
      txWaveform = [txWaveform; txWaveformforpk{ind}];
end
end
